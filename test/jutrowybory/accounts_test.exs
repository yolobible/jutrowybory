defmodule Jutrowybory.AccountsTest do
  use Jutrowybory.DataCase

  alias Jutrowybory.Accounts

  import Jutrowybory.AccountsFixtures
  alias Jutrowybory.Accounts.{User, UserToken}
  ...
  describe "register_user/1" do
    ...
    test "requires password and assigns obywatel_N username" do
