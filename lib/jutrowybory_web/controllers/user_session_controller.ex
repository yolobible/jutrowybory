defmodule JutrowyboryWeb.UserSessionController do
  ...
  def create(conn, %{"user" => %{"email" => email, "password" => password} = user_params}) do
    if user = Accounts.get_user_by_email_and_password(email, password) do
      ...
      conn
      |> put_flash(:error, "Nieprawidłowy e-mail lub hasło")
  ...
  def create(conn, %{"user" => %{"email" => email}}) do
    ...
    info =
      "Jeśli Twój e-mail jest w naszym systemie, otrzymasz instrukcje logowania."
